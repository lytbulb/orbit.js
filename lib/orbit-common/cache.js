...
var Cache = Class.extend({
  ...
  transform: function(operation) {
    ...
    var operationType = this.schema.operationEncoder.identify(normalizedOperation);
    ...
    if(this.schema.operationEncoder.isLinkOp(operation)){
  ...
  _ensureLinkIsInitialized: function(type, id, link){
    ...
    if(linkValue === OC.LINK_NOT_INITIALIZED) {
      this._doc.transform(this.schema.operationEncoder.initializeLinkOp(type, id, link));
    }
  },
